...
export const ImportModule: React.FC<ImportModuleProps> = ({ existingTransactions, onConfirm, onCancel }) => {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.type === 'application/pdf') {
      ...
      reader.onerror = () => {
        setError("Erro ao ler o arquivo de texto.");
        setIsProcessing(false);
      };
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          ...
          {step === 'input' ? (
            ...
            <div className="space-y-6 animate-in fade-in zoom-in-95 duration-500">
              <div className="flex items-center gap-6 bg-emerald-500/10 p-6 rounded-[2rem] border border-emerald-500/20 shadow-xl">
                <div className="w-14 h-14 bg-emerald-600 rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-lg">
